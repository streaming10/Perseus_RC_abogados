...
<div class="contact-page" style="padding: 2rem 0;">
  ...
  <div class="quick-services" style="background: var(--primary-white); padding: 2.5rem; border-radius: 8px; box-shadow: var(--shadow-light); margin-bottom: 3rem;">
    <h2 style="color: var(--navy-blue); font-size: 1.8rem; margin-bottom: 1.5rem; text-align: center;">¿En qué podemos ayudarte?</h2>
    
    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 1.5rem;">
      
      <div style="background: var(--accent-light-gold); padding: 1.5rem; border-radius: 8px;">
        <h3 style="color: var(--navy-blue); margin-bottom: 1rem; font-size: 1.1rem;">🔒 Delitos Informáticos</h3>
        <p style="color: var(--text-secondary); font-size: 0.95rem; line-height: 1.5; margin-bottom: 1rem;">
          Cibercrimen, fraude online, estafas digitales, suplantación de identidad
        </p>
        <a href="{{ '/servicios/delitos-informaticos/' | relative_url }}" style="color: var(--navy-blue); text-decoration: none; font-weight: 500; font-size: 0.9rem;">
          Ver más detalles →
        </a>
      </div>

      <div style="background: var(--accent-light-gold); padding: 1.5rem; border-radius: 8px;">
        <h3 style="color: var(--navy-blue); margin-bottom: 1rem; font-size: 1.1rem;">💰 Recuperación de Deudas</h3>
        <p style="color: var(--text-secondary); font-size: 0.95rem; line-height: 1.5; margin-bottom: 1rem;">
          Impagados, procedimientos monitorio, ejecuciones, concursos
        </p>
        <a href="{{ '/servicios/recuperacion-deudas/' | relative_url }}" style="color: var(--navy-blue); text-decoration: none; font-weight: 500; font-size: 0.9rem;">
          Ver más detalles →
        </a>
      </div>

      <div style="background: var(--accent-light-gold); padding: 1.5rem; border-radius: 8px;">
        <h3 style="color: var(--navy-blue); margin-bottom: 1rem; font-size: 1.1rem;">⚖️ Derecho Civil y Penal</h3>
        <p style="color: var(--text-secondary); font-size: 0.95rem; line-height: 1.5; margin-bottom: 1rem;">
          Contratos, responsabilidad civil, herencias, derecho laboral
        </p>
        <a href="{{ '/servicios/' | relative_url }}" style="color: var(--navy-blue); text-decoration: none; font-weight: 500; font-size: 0.9rem;">
  ...
  <div class="contact-form-section" style="background: var(--navy-blue); color: var(--primary-white); padding: 3rem; border-radius: 8px; margin-bottom: 3rem;">
    <div style="max-width: 600px; margin: 0 auto;">
      <h2 style="color: var(--accent-gold); font-size: 1.8rem; margin-bottom: 1rem; text-align: center;">Consulta Online</h2>
      <p style="text-align: center; margin-bottom: 2rem; color: rgba(255, 255, 255, 0.9);">
      ...
      <div style="background: rgba(255, 255, 255, 0.1); padding: 2rem; border-radius: 8px;">
        <div style="margin-bottom: 1.5rem;">
          <label style="display: block; margin-bottom: 0.5rem; color: var(--accent-light-gold); font-weight: 500;">Nombre Completo *</label>
          <input type="text" style="width: 100%; padding: 0.8rem; border: 1px solid rgba(255, 255, 255, 0.3); border-radius: 4px; background: rgba(255, 255, 255, 0.1); color: white;" placeholder="Tu nombre y apellidos">
        </div>

        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1rem; margin-bottom: 1.5rem;">
          <div>
            <label style="display: block; margin-bottom: 0.5rem; color: var(--accent-light-gold); font-weight: 500;">Teléfono *</label>
            <input type="tel" style="width: 100%; padding: 0.8rem; border: 1px solid rgba(255, 255, 255, 0.3); border-radius: 4px; background: rgba(255, 255, 255, 0.1); color: white;" placeholder="+34 600 000 000">
          </div>
          <div>
            <label style="display: block; margin-bottom: 0.5rem; color: var(--accent-light-gold); font-weight: 500;">Email *</label>
            <input type="email" style="width: 100%; padding: 0.8rem; border: 1px solid rgba(255, 255, 255, 0.3); border-radius: 4px; background: rgba(255, 255, 255, 0.1); color: white;" placeholder="tu@email.com">
          </div>
        </div>

        <div style="margin-bottom: 1.5rem;">
          <label style="display: block; margin-bottom: 0.5rem; color: var(--accent-light-gold); font-weight: 500;">Tipo de Consulta</label>
          <select style="width: 100%; padding: 0.8rem; border: 1px solid rgba(255, 255, 255, 0.3); border-radius: 4px; background: rgba(255, 255, 255, 0.1); color: var(--navy-blue);">
            <option>Delitos Informáticos</option>
            <option>Recuperación de Deudas</option>
        ...
        <div style="margin-bottom: 2rem;">
          <label style="display: block; margin-bottom: 0.5rem; color: var(--accent-light-gold); font-weight: 500;">Cuéntanos tu caso *</label>
          <textarea style="width: 100%; height: 120px; padding: 0.8rem; border: 1px solid rgba(255, 255, 255, 0.3); border-radius: 4px; background: rgba(255, 255, 255, 0.1); color: white; resize: vertical;" placeholder="Describe brevemente tu situación legal. Cuantos más detalles nos proporciones, mejor podremos ayudarte."></textarea>
        </div>

        <div style="margin-bottom: 1.5rem;">
          <label style="display: flex; align-items: center; gap: 0.5rem; color: rgba(255, 255, 255, 0.9); font-size: 0.9rem;">
            <input type="checkbox" style="margin: 0;">
            He leído y acepto la <a href="{{ '/politica-privacidad/' | relative_url }}" style="color: var(--accent-light-gold); text-decoration: none;">política de privacidad</a>
          </label>
        </div>

        <div style="text-align: center;">
          <button type="submit" style="background: var(--accent-gold); color: var(--navy-blue); border: none; padding: 1rem 2.5rem; border-radius: 25px; font-size: 1.1rem; font-weight: 500; cursor: pointer; transition: all 0.3s ease;">
            Enviar Consulta
          </button>
        </div>

        <p style="text-align: center; margin-top: 1rem; color: rgba(255, 255, 255, 0.7); font-size: 0.85rem;">
          * Campos obligatorios. Respuesta garantizada en 24h laborables.
        </p>
      </div>
    </div>
  </div>
  ...
  <div class="location-section" style="background: var(--primary-white); padding: 2.5rem; border-radius: 8px; box-shadow: var(--shadow-light);">
    ...
    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 2rem; align-items: start;">
      ...
      <div>
        ...
        <div style="text-align: center;">
          <a href="https://goo.gl/maps/[enlace-directo]" target="_blank" rel="noopener" style="display: inline-block; background: var(--accent-gold); color: var(--navy-blue); padding: 0.8rem 1.5rem; text-decoration: none; border-radius: 25px; font-weight: 500; transition: all 0.3s ease;">
